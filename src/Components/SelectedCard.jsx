...
const SelectedCard = ({ selectedCard, setSelectedCard, setCart }) => {
    ...
    return (
        <div className='mt-6 border border-zinc-200 rounded-xl p-4 sm:p-6 w-full'>
            {
                selectedCard.length === 0 ? <p className='flex justify-center items-center flex-col'><span className='font-semibold text-2xl'>Cart Section Empty</span> <br /> <span className='text-gray-400'>Please Buy something</span></p> :
                    <>
